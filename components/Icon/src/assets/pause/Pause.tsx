...
export type PauseIconProps = Omit<SVGProps<SVGSVGElement> & { size?: number; color?: IconColorProp }, 'style'> & {
...
(PauseIcon as React.FC<PauseIconProps> & { hasStyleVariant: true }).hasStyleVariant = true;
