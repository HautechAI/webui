...
describe('NodeGroupHeader', () => {
    it('should render without crashing', () => {
        render(withTheme(
            <NodeGroupHeader label="Test Header" collapsed={false} />
        ));
    });
    ...
    it('should call onToggle when clicked', () => {
        ...
        const { getByText } = render(withTheme(
            <NodeGroupHeader label="Test Header" collapsed={false} onToggle={onToggle} />
        ));
...
describe('NodeGroupItem', () => {
    ...
    it('should render title and icon correctly', () => {
        const { getByText, getByTestId } = render(withTheme(
            <NodeGroupItem icon={<TestIcon />} title="Test Item" />
        ));
        expect(getByText('Test Item')).toBeInTheDocument();
