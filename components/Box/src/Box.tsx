...
export const Box = forwardRef((props: BoxProps, ref: React.ForwardedRef<HTMLDivElement>) => {
    ...
    const styleInline: React.CSSProperties = {
        ...
        ...(padding ? { padding: themeVars.spacing[padding] } : {}),
        ...(paddingTop ? { paddingTop: themeVars.spacing[paddingTop] } : {}),
        ...(paddingRight ? { paddingRight: themeVars.spacing[paddingRight] } : {}),
        ...(paddingBottom ? { paddingBottom: themeVars.spacing[paddingBottom] } : {}),
        ...(paddingLeft ? { paddingLeft: themeVars.spacing[paddingLeft] } : {}),
        ...(overflow ? { overflow } : {}),
        ...(overflowX ? { overflowX } : {}),
        ...(overflowY ? { overflowY } : {}),
        alignItems,
