...
import { TabRow } from '@hautechai/webui.tabrow';
...
export const ButtonContainer = styled.div<{
    ...
    transition: background-color 0.5s ease, border-color 0.3s ease, outline-color 0.3s ease, transform 0.3s ease;
...
const OptionsContainer = styled.div<{ isOpen?: boolean }>`
    ...
    border-radius: ${({ theme }) => theme.foundation.cornerRadius.m}px;
    box-shadow: 0px 0px 14px 0px rgba(42, 47, 60, 0.08);
            ...
            <OptionsContainer isOpen={isOpen}>
                <Column spacing="s">
                    {props.options.map((opt) => (
                        ...
                        >
                            <TabRow label={opt.label} type="main" size="small" isSelected={opt.value === props.value} />
                        </div>
                    ))}
                </Column>
            </OptionsContainer>
